...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\OSPanel\home\my-app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\OSPanel\\home\\my-app\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'post.index','post.create','post.store',
'post.show','post.edit','post.update','post.delete','main.index',
'contact.index','about.index','storage.local',);
        registerArgumentsSet('views', 
'about','contacts','layouts.main','main','post.create',
'post.edit','post.index','post.show','welcome','laravel-exceptions-renderer::components.card',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_DEV_SERVER',);
